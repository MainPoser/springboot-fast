package cn.com.datu.springboot.oauth2server.common.disruptors.consumer;
...
@Component
@Slf4j
public class SysOperLogIndexEventHandler extends AbstractEventHandler<SysOperLogEvent, SysOperLog> {
    ...
    protected void doBatchHandle(List<SysOperLog> sycList) {
        log.info("storage Index:<{}>", JSON.toJSONString(sycList));
    }

    @Override
    public String getName() {
        return "SysOperLogIndexEventHandler";
    }
}
